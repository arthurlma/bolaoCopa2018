...
@Component({
  selector: 'app-palpites-grupo',
  templateUrl: './palpites-grupo.component.html',
  styleUrls: ['./palpites-grupo.component.css']
})
export class PalpitesGrupoComponent implements OnInit {
